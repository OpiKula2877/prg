...
if today_jidla_list:
    if random_c == 1:
        message_parts = [f"-------------------------------------------------------------\n# Jídelníček na **{today}**\n\n **Dobrý ránko, Nedáme si dneska takovej menší špíček?**\n"]
    elif random_c == 2:
        message_parts = [f"-------------------------------------------------------------\n# Jídelníček na **{today}**\n\n **Dobrý ráno pánové, hele, tak tohle je bomba, zrovna jsem jel takhle do práce a najednou jsem se dozvědel, co máme dneska k obedu.**\n"]
    elif random_c == 3:
        message_parts = [f"-------------------------------------------------------------\n# Jídelníček na **{today}**\n\n **Dobrý večer... No vstáváme, vstáváme... Co ten koš chlapci?**\n"]
...
WEBHOOK_URL2 = "https://discord.com/api/webhooks/1447868216821944416/KalVe35Q5sKG3axOlWaFmqM_J9W8TvV8qyO_zAh9sDi3ZkvW2sHfsmRQaqVCvKHgTX1z"
WEBHOOK_URL3 = "https://discord.com/api/webhooks/1447868485047812147/rk8jLgEXy2gWrCDNiakG_u-FprmJnBkHGXi0ZvLcGtPpLKiAIi-RlHYhm44oStWsBxsH"
...
if random_c == 1:
    ...
    response = requests.post(WEBHOOK_URL3, json=data)
