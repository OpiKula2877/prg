...
VALUES
-- WEB SERVER 01
(@srv_web_01, @svc_nginx, 'www.company.local', '10.0.10.11', NULL, 80,  'HTTP', '2026-01-02', 'Running'),
(@srv_web_01, @svc_node,  'api.company.local', '10.0.10.11', NULL, 3000,'HTTP', '2026-01-31', 'Stopped'),
(@srv_web_01, @svc_docker, NULL,               '10.0.10.11', NULL, NULL, NULL, '2026-01-05', 'Installed'),

-- WEB SERVER 02
(@srv_web_02, @svc_nginx, 'shop.company.local','10.0.10.12', NULL, 443, 'HTTPS', '2026-01-02', 'Running'),
(@srv_web_02, @svc_docker,NULL,                '10.0.10.12', NULL, NULL, NULL, '2026-01-02', 'Running'),

-- DB SERVER
(@srv_db_01, @svc_mariadb, NULL, '10.0.20.10', NULL, 3306, 'TCP', '2026-01-02', 'Running'),
(@srv_db_01, @svc_prometheus, NULL, '10.0.20.10', NULL, 9090, 'HTTP', '2026-01-02', 'Running'),

-- MAIL SERVER
(@srv_mail_01, @svc_postfix, 'mail.company.local', '10.0.30.5', NULL, 25, 'SMTP', '2026-01-02', 'Running'),

-- DEV SERVER
(@srv_dev_01, @svc_docker, NULL, '10.0.40.15', NULL, NULL, NULL, '2026-01-02', 'Running'),
(@srv_dev_01, @svc_node,   'dev-api.company.local', '10.0.40.15', NULL, 3001, 'HTTP', '2026-01-02', 'Running');
